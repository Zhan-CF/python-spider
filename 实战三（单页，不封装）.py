        ...
        if not y_n:  #不需要展开的一级评论
            ...
            with open('实战三_one_comments.csv', 'a', newline='', encoding='utf-8') as f:
                ...
                for one_comment in one_comments:
                    ...
                    #print(post_id, one_comment_author, one_comment_time, one_comment_content, one_comment_ip)
                    #comment_id = insert_to_db(one_comment_data)
                    writer.writerow([one_comment_author, one_comment_content, one_comment_time, one_comment_ip])
